...
const MatchEntryForm = ({ matchId, initialData, onSuccess }) => {
  ...
  // const [matchId, setMatchId] = useState(null); // from URL or existing match
  const [savedMatchId, setSavedMatchId] = useState(null); // from successful save
        ...
        >
          ...
          {savedMatchId && (
            <Box mt={3} textAlign="center">
              ...
              >
                {isGenerating
                  ? "Generating Predictions & Slips..."
                  : "Generate Predictions & Slips"}
              </Button>
            </Box>
          )}

          {/* optional current match processing status  */}
